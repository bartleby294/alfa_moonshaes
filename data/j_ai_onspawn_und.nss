...
/************************ [Important Spawn Settings] **************************/
    SetAIInteger(AI_INTELLIGENCE, 7);
...
************************* [User Defined and Shouts] ***************************/
 ...
 /*** Speakstrings - as it were, said under cirtain conditions % chance each time ***/
    ...
    //AI_SetSpawnInSpeakArray(AI_TALK_ON_COMBAT_ROUND_THEM_OVER_US, 5, 4, "Come on lads! We can do this!", "Tough man, are we?", "Trying out your 'skills'? Pathetic excuse!", "Nothing good will come from killing me!");
...
************************* [User] **********************************************/
    ...
    effect vfx = EffectUltravision();
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, vfx, OBJECT_SELF);

    ExecuteScript("jc_troll_spawn", OBJECT_SELF);     //make invulnerable
    ExecuteScript("nw_c2_default9bk", OBJECT_SELF);   //set attak my target and stealth
