...
//
//  (c) BioWare Corp, 1999
//  All ALFA changes can be found by searching for "ALFA".
////////////////////////////////////////////////////////
...
int BASE_ITEM_TRIDENT               = 211; // ALFA Change, see baseitems.2da
int BASE_ITEM_HORSE_BRIDLE          = 223; // ALFA Change, see baseitems.2da and acr_horse_i.nss
...
int SKILL_SPEAK_LANGUAGE   = 27; // ALFA additions
int SKILL_CLIMB            = 28;
int SKILL_SENSE_MOTIVE     = 29;
int SKILL_FORGERY          = 30;
int SKILL_INNUENDO         = 31;
int SKILL_JUMP             = 32;
int SKILL_SWIM             = 33;
int SKILL_RIDE             = 34; // End ALFA additions
