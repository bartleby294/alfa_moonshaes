...
if(nSpellID == IP_CONST_CASTSPELL_IMPROVED_INVISIBILITY_7           ||
nSpellID == IP_CONST_CASTSPELL_STONESKIN_7                          ||
nSpellID == IP_CONST_CASTSPELL_ICE_STORM_9                          ||
nSpellID == IP_CONST_CASTSPELL_DEATH_WARD_7                         ||

nSpellID == IP_CONST_CASTSPELL_BESTOW_CURSE_5                       ||
nSpellID == IP_CONST_CASTSPELL_CHARM_MONSTER_5                      ||
nSpellID == IP_CONST_CASTSPELL_CHARM_PERSON_10                      ||
nSpellID == IP_CONST_CASTSPELL_CONFUSION_5                          ||
nSpellID == IP_CONST_CASTSPELL_CONFUSION_10                         ||
nSpellID == IP_CONST_CASTSPELL_CONTAGION_5                          ||
nSpellID == IP_CONST_CASTSPELL_ELEMENTAL_SHIELD_7                   ||
nSpellID == IP_CONST_CASTSPELL_ELEMENTAL_SHIELD_12                  ||
nSpellID == IP_CONST_CASTSPELL_ENERVATION_7                         ||
nSpellID == IP_CONST_CASTSPELL_EVARDS_BLACK_TENTACLES_7             ||
nSpellID == IP_CONST_CASTSPELL_EVARDS_BLACK_TENTACLES_15            ||
nSpellID == IP_CONST_CASTSPELL_FEAR_5                               ||
nSpellID == IP_CONST_CASTSPELL_ICE_STORM_9                          ||
nSpellID == IP_CONST_CASTSPELL_ISAACS_LESSER_MISSILE_STORM_13       ||
nSpellID == IP_CONST_CASTSPELL_LESSER_SPELL_BREACH_7                ||
nSpellID == IP_CONST_CASTSPELL_MINOR_GLOBE_OF_INVULNERABILITY_7     ||
nSpellID == IP_CONST_CASTSPELL_MINOR_GLOBE_OF_INVULNERABILITY_15    ||
nSpellID == IP_CONST_CASTSPELL_PHANTASMAL_KILLER_7                  ||
nSpellID == IP_CONST_CASTSPELL_POLYMORPH_SELF_7                     ||
nSpellID == IP_CONST_CASTSPELL_REMOVE_BLINDNESS_DEAFNESS_5          ||
nSpellID == IP_CONST_CASTSPELL_REMOVE_CURSE_5                       ||
nSpellID == IP_CONST_CASTSPELL_SHADOW_CONJURATION_7                 ||
nSpellID == IP_CONST_CASTSPELL_STONESKIN_7                          ||
nSpellID == IP_CONST_CASTSPELL_SUMMON_CREATURE_IV_7                 ||
nSpellID == IP_CONST_CASTSPELL_WALL_OF_FIRE_9                       ||

nSpellID == IP_CONST_CASTSPELL_DISMISSAL_12                         ||
nSpellID == IP_CONST_CASTSPELL_DISMISSAL_18                         ||
nSpellID == IP_CONST_CASTSPELL_DISMISSAL_7                          ||
nSpellID == IP_CONST_CASTSPELL_DOMINATE_PERSON_7                    ||
nSpellID == IP_CONST_CASTSPELL_HOLD_MONSTER_7                       ||
nSpellID == IP_CONST_CASTSPELL_LEGEND_LORE_5                        ||
nSpellID == IP_CONST_CASTSPELL_WAR_CRY_7                            ||

nSpellID == IP_CONST_CASTSPELL_DIVINE_POWER_7                       ||
nSpellID == IP_CONST_CASTSPELL_FREEDOM_OF_MOVEMENT_7                ||
nSpellID == IP_CONST_CASTSPELL_HAMMER_OF_THE_GODS_12                ||
nSpellID == IP_CONST_CASTSPELL_HAMMER_OF_THE_GODS_7                 ||
nSpellID == IP_CONST_CASTSPELL_INFLICT_CRITICAL_WOUNDS_12           ||
nSpellID == IP_CONST_CASTSPELL_POISON_5                             ||
nSpellID == IP_CONST_CASTSPELL_RESTORATION_7                        ||

nSpellID == IP_CONST_CASTSPELL_FLAME_STRIKE_7                       ||
nSpellID == IP_CONST_CASTSPELL_FLAME_STRIKE_12                      ||
nSpellID == IP_CONST_CASTSPELL_FLAME_STRIKE_18                      ||
nSpellID == IP_CONST_CASTSPELL_MASS_CAMOFLAGE_13                    ||

nSpellID == 429                                                     ||  //this seems to be value for PC scribed CCW
nSpellID == IP_CONST_CASTSPELL_CURE_CRITICAL_WOUNDS_7               ||
nSpellID == IP_CONST_CASTSPELL_CURE_CRITICAL_WOUNDS_12              ||
nSpellID == IP_CONST_CASTSPELL_CURE_CRITICAL_WOUNDS_15
)
nRet = 4;
...
oScroll = GetScroll();
iSpellID = GetItemPropertySubType(GetProperty(oScroll, ITEM_PROPERTY_CAST_SPELL));
...
if(iRoll == 1 || (iRoll + iSkill < iDC)){
  ...
  if(iRoll == 20 || (iRoll + iSkill >= iDC + 10)){
    if(iSpellLevel != 0){
      ...
      SendMessageToPC(oPC, "You cannot mastercraft level 0 spells.");
  }
  ...
  if(HasItem("ay_ingot_iron")){
    ...
    AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyCastSpell(iSpellID, IP_CONST_CASTSPELL_NUMUSES_1_CHARGE_PER_USE), oWeapon);
  }
  else if(HasItem("ay_ingot_silver")){
   // RemoveWeaponProperty(oWeapon, ITEM_PROPERTY_AC_BONUS);
    AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyCastSpell(iSpellID, IP_CONST_CASTSPELL_NUMUSES_1_USE_PER_DAY), oWeapon);
    /*if(iDamageType){
  ...
  //SendMessageToPC(oPC, "Weapon modification DC Adjustment: " + IntToString(iModDC));
    ...
    //RemoveWeaponProperty(oWeapon, ITEM_PROPERTY_AC_BONUS);
    AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyCastSpell(iSpellID, IP_CONST_CASTSPELL_NUMUSES_2_USES_PER_DAY), oWeapon);
    /*if(iDamageType){
      RemoveWeaponProperty(oWeapon, ITEM_PROPERTY_IMMUNITY_DAMAGE_TYPE);
      AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyDamageImmunity(iDamageType, iDamage),oWeapon);
      SendMessageToPC(oPC, "The armor glows with alchemical power ");
  ...
  //SendMessageToPC(oPC, "Weapon modification DC Adjustment: " + IntToString(iModDC));
    ...
    //RemoveWeaponProperty(oWeapon, ITEM_PROPERTY_AC_BONUS);
    AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyCastSpell(iSpellID, IP_CONST_CASTSPELL_NUMUSES_3_USES_PER_DAY), oWeapon);
    /*if(iDamageType){
      RemoveWeaponProperty(oWeapon, ITEM_PROPERTY_IMMUNITY_DAMAGE_TYPE);
      AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyDamageImmunity(iDamageType, iDamage),oWeapon);
      SendMessageToPC(oPC, "The armor glows with alchemical power ");
  ...
  //SendMessageToPC(oPC, "Weapon modification DC Adjustment: " + IntToString(iModDC));
    ...
    //RemoveWeaponProperty(oWeapon, ITEM_PROPERTY_AC_BONUS);
    AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyCastSpell(iSpellID, IP_CONST_CASTSPELL_NUMUSES_4_USES_PER_DAY), oWeapon);
    /*if(iDamageType){
      RemoveWeaponProperty(oWeapon, ITEM_PROPERTY_IMMUNITY_DAMAGE_TYPE);
      AddItemProperty(DURATION_TYPE_PERMANENT, ItemPropertyDamageImmunity(iDamageType, iDamage),oWeapon);
      SendMessageToPC(oPC, "The armor glows with alchemical power ");
  ...
  if(GetBaseItemType(oWeapon) == BASE_ITEM_BLANK_WAND){
    if(!GetIsDM(oPC)){
      SendMessageToPC(oPC, "This is not possible with a scroll. ");
      return;
    }
    ...
    //iProp = ItemPropertyLimitUseByClass(GetLastSpellCastClass());
    //SendMessageToPC(oPC, "Last SpellCasatClass: " + IntToString(GetLastSpellCastClass()));
