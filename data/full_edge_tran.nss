...
{ /// Begin User-Defined Variables ///
    float fMaxAreaDim = 240.0f;     // 10.0 per tile in one dimension.  (Areas under 3x3 not recommended)
                                    // Example: 16x16 areas would use 160.0f, 8x8 areas would use 80.0f, etc.

                                    //    NOTE:  Linked areas _MUST_ be square only!

    float fLandingOffset = 10.0f;    // Distance out from edge in destination Area that PC will land (8 to 10 recommended)
