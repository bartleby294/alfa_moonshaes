...
*/
    ...
    oWayPoint = GetNearestObjectByTag("cw_cd_bar");
    ...
    AddTask(yarriTask);
    //  Set waypoint/task 2 (Sits down on the chair)
    oWayPoint = GetNearestObjectByTag("cd_ch12");
    yarriTask.oWaypoint = oWayPoint;
    ...
    oWayPoint = GetNearestObjectByTag("th_cd_hntr2");
    yarriTask.oWaypoint = oWayPoint;
    ...
    yarriTask.bRunToPoint = FALSE;
    AddTask(yarriTask);
    //  Set waypoint/task 4 (Starts a conversation with patron)
    ...
    yarriTask.bRunToPoint = FALSE;
    AddTask(yarriTask);
    //  Set waypoint/task 5 (Starts a conversation with patron)
    oWayPoint = GetNearestObjectByTag("th_cd_com3");
    yarriTask.oWaypoint = oWayPoint;
    yarriTask.associatedCommand = NPC_COMMAND_TALKNORMAL;
    yarriTask.dayNight = NPC_TIME_ALWAYS;
    //yarriTask.percentChance = 50;  //  This parameter does nothing atm
