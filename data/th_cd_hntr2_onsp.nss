...
*/
    ...
    AddTask(yarriTask);
    //  Set waypoint/task 2 (Drinks while conversing with another patron)
    oWayPoint = GetNearestObjectByTag("th_cd_com5");
    yarriTask.oWaypoint = oWayPoint;
    yarriTask.associatedCommand = NPC_COMMAND_DRINK;
    yarriTask.dayNight = NPC_TIME_ALWAYS;
    //yarriTask.percentChance = 50;   //  This parameter does nothing atm
    yarriTask.fDuration = 50.0;
    yarriTask.bRunToPoint = FALSE;
    AddTask(yarriTask);
    //  Set waypoint/task 3 (Drinks while conversing with another patron)
    oWayPoint = GetNearestObjectByTag("th_cd_com6");
    yarriTask.oWaypoint = oWayPoint;
    yarriTask.associatedCommand = NPC_COMMAND_DRINK;
    yarriTask.dayNight = NPC_TIME_ALWAYS;
    //yarriTask.percentChance = 50;   //  This parameter does nothing atm
    ...
    yarriTask.bRunToPoint = FALSE;
    AddTask(yarriTask);
    //  Set waypoint/task 4 (Sits down on the chair)
    oWayPoint = GetNearestObjectByTag("cd_ch11");
    yarriTask.oWaypoint = oWayPoint;
    yarriTask.associatedCommand = NPC_COMMAND_SIT;
    yarriTask.dayNight = NPC_TIME_ALWAYS;
    //yarriTask.percentChance = 50;   //  This parameter does nothing atm
    yarriTask.fDuration = 60.0;
    yarriTask.bRunToPoint = FALSE;
    AddTask(yarriTask);
    //  Set waypoint/task 5 (Sits down on the chair)
    oWayPoint = GetNearestObjectByTag("cd_ch18");
    yarriTask.oWaypoint = oWayPoint;
    yarriTask.associatedCommand = NPC_COMMAND_SIT;
    yarriTask.dayNight = NPC_TIME_ALWAYS;
    //yarriTask.percentChance = 50;   //  This parameter does nothing atm
    yarriTask.fDuration = 40.0;
    yarriTask.bRunToPoint = FALSE;
    AddTask(yarriTask);
    }
