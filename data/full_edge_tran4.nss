...
{ /// Begin User-Defined Variables ///
    ...
    float fLandingOffset = 14.0f;    // Distance out from edge in destination Area that PC will land (8 to 10 recommended)
    float fDiagTransSize = 14.0f;    // Distance out from any corner to sense diagonal movement (8 to 15 recommended)
    float fTransitionDelay = 14.0f;  // Delay before zoning, used to prevent cheating by PC's (2.0 to 4.0 recommended)
