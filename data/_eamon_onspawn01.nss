...
void main()
{
    ...
    SetListenPattern(OBJECT_SELF,"Bitter Black please Eamon**",2002);
    SetListenPattern(OBJECT_SELF,"Dragon's Breath Beer please Eamon**",2003);
    SetListenPattern(OBJECT_SELF,"Mead please Eamon**",2004);
    SetListenPattern(OBJECT_SELF,"Winter Wine please Eamon**",2005);
    SetListenPattern(OBJECT_SELF,"White Wine please Eamon**",2006);
    SetListenPattern(OBJECT_SELF,"Spiced Wine please Eamon**",2007);
    SetListenPattern(OBJECT_SELF,"Red Wine please Eamon**",2008);
    SetListenPattern(OBJECT_SELF,"Coffee please Eamon**",2009);
    SetListenPattern(OBJECT_SELF,"Ale please Eamon**",2010);
    SetListenPattern(OBJECT_SELF,"Milk please Eamon**",2011);
    SetListenPattern(OBJECT_SELF,"Tea please Eamon**",2012);
    SetListenPattern(OBJECT_SELF,"Spirits please Eamon**",2013);
    SetListenPattern(OBJECT_SELF,"Water please Eamon**",2014);

    SetListenPattern(OBJECT_SELF,"Hello Eamon**",2015);
    SetListenPattern(OBJECT_SELF,"Hows business Eamon**",2016);
