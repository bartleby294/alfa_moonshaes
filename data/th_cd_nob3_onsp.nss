...
*/
    ...
    object                 oWayPoint;
    //  Set waypoint/task 1 (Drinks while conversing with another patron)
    oWayPoint = GetNearestObjectByTag("th_cd_nob1");
    ...
    oWayPoint = GetNearestObjectByTag("th_cd_nob4");
    yarriTask.oWaypoint = oWayPoint;
    yarriTask.associatedCommand = NPC_COMMAND_DRINK;
    yarriTask.dayNight = NPC_TIME_ALWAYS;
    //yarriTask.percentChance = 50;   //  This parameter does nothing atm
    ...
    yarriTask.bRunToPoint = FALSE;
    AddTask(yarriTask);
    //  Set waypoint/task 3 (Sits down on the chair)
