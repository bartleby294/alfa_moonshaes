...
************************* [Combat Other - Healers/Healing] ********************/
    ...
    SetAIInteger(AI_HEALING_US_PERCENT, 55);
...
************************* [User Defined and Shouts] ***************************/
 ...
 /*** Speakstrings - as it were, said under cirtain conditions % chance each time ***/
    ...
    // Morale
    AI_SetSpawnInSpeakArray(AI_TALK_ON_MORALE_BREAK, 100, 3, "No more!", "I'm outta here!");
    ...
    AI_SetSpawnInSpeakValue(AI_TALK_ON_STUPID_RUN, "Ahhhhgggg! NO MORE! Fleeee!!");
