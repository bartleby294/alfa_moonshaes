...
void main()
{
    ...
    */
    ...
    if(PosState == 0)
    {
        if(GetDistanceBetween(OBJECT_SELF, WP5) > 5.0)
        {
    ...
    if(PosState == 1)
    {
        ...
        else
        {
            ...
            SetLocalInt(OBJECT_SELF, "PosState",2);
            return;
        }
    }
    ...
    if(PosState == 6)
    {
        ...
        if(GetDistanceBetween(OBJECT_SELF, WP4) > 2.0)
        {
            ...
            SetLocalInt(OBJECT_SELF,"6StateTime", StateTime6);
            return;
        }
        else
        {
