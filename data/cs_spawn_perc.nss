//  This script should be used in the OnSpawn handler of
//  any NPC you wish to say a line when they perceive the PC.
//  There are two uses for this script:
//  1. A friendly NPC who calls out to the PC upon perceiving them
//  2. An enemy NPC who calls out a line as they charge towards the PC to attack

//  Usage: Add this to the OnSpawn and add the "NW_D2_Gen_Check" to the
//  first node of the NPCs conversation.
...
void main()
{
    ...
    // * conversation file upon perceiving the player. Put [NW_D2_Gen_Check]
