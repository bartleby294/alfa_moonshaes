/************************ [On Spawn] *******************************************
    ALFA AJAI 1.31 OnSpawn
    Filename: ja_ai_onspawn or nw_c2_default9
************************* [On Spawn] *******************************************
...
************************* [Fleeing] *******************************************/
    ...
    SetAIInteger(HP_PERCENT_TO_CHECK_AT, 40);
    ...
    SetAIInteger(AI_DAMAGE_AT_ONCE_PENALTY, 4);
...
************************* [User Defined and Shouts] ***************************/
 ...
 /*** Speakstrings - as it were, said under cirtain conditions % chance each time ***/
    ...
    // Combat
    AI_SetSpawnInSpeakArray(AI_TALK_ON_COMBAT_ROUND_EQUAL, 5, 4, "Ugggh!", "Me eats you!", "Club smash you down", "Me crush you good!");
    AI_SetSpawnInSpeakArray(AI_TALK_ON_COMBAT_ROUND_THEM_OVER_US, 5, 4, "Ugggh!", "Me eats you!", "Club smash you down", "Me crush you good!");
    ...
    // Event-driven.
    AI_SetSpawnInSpeakArray(AI_TALK_ON_PERCIEVE_ENEMY, 70, 2, "Food!", "Meat!");
        // This is said when they see/hear a new enemy, and start attacking them.
    AI_SetSpawnInSpeakArray(AI_TALK_ON_DAMAGED, 20, 2, "Grrrr!", "Scratch me bad!");
