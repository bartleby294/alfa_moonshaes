...
void main()
{
 ...
 if(sItem == "043_GREYBRDL_01")
    {

       // get the Bridle's activator and target, put target info into local vars on activator
       SetLocalObject(oOwner, "GBTarget", oTarget);
       SetLocalLocation(oOwner, "GBLoc", lLoc);
      ...
      AssignCommand(oOwner, ActionStartConversation(OBJECT_SELF, "c_horse_06", TRUE));
           }
           object oMyTarget = GetLocalObject(oOwner, "GBTarget");
