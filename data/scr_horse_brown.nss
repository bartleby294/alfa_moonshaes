...
void main()
{
 ...
 if(sItem == "043_BRWNBRDL_01")
    {

       // get the Bridle's activator and target, put target info into local vars on activator
       SetLocalObject(oOwner, "BRBTarget", oTarget);
       SetLocalLocation(oOwner, "BRBLoc", lLoc);
      ...
      AssignCommand(oOwner, ActionStartConversation(OBJECT_SELF, "c_horse_05", TRUE));
           }
           object oMyTarget = GetLocalObject(oOwner, "BRBTarget");
