...
int MoonshaesCustom(object oPC)
{
   ...
   //partial bandit treasure map
   if(GetStringLeft(GetTag(oItem), 8) == "ms_bmap_")
   {
        ExecuteScript("ms_b_tmap_comb", oPC);
        return TRUE;
   }
   ...
   if(GetTag(oItem) == "healingsalve" || GetTag(oItem) == "nanshealingsalve") {
