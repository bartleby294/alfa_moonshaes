...
{ /// Begin User-Defined Variables ///
    ...
    float fLandingOffset = 6.0f;    // Distance out from edge in destination Area that PC will land (8 to 10 recommended)
    float fDiagTransSize = 6.0f;    // Distance out from any corner to sense diagonal movement (8 to 15 recommended)
